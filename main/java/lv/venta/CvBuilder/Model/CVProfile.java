...
public class CVProfile {
    ...
    @Pattern(regexp = "[A-Z]{1}[a-z]{0,9}", message = "First Name must Start with capital letter (e.g., Favour)")
    private String firstName;

    @NotNull
    @Size(min = 2, max = 50, message = "Last name must be between 2 and 50 characters")
    @Column(name = "Last_Name")
    @Pattern(regexp = "[A-Z]{1}[a-z]{0,9}", message = "Last Name must Start with capital letter (e.g., Obi)")
    ...
    public CVProfile(int idcp, String firstName, String lastName, String email, String summary) {
        setIdcp(idcp);
